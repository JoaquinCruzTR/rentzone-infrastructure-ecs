...
module "route-53" {
  source                             = "git@github.com:JoaquinCruzTR/terraform-modules.git//route-53"
...
#print the wbsite url
output "website_url" {
  value = join("", ["https://", var.record_name, ".", module.ssl_certificate.domain_name])
}